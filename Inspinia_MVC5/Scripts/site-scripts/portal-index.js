$(function () {
    ...
    $(document).ready(function () {
        ...
        $("#tourModal").modal();
        $.get("/portal/CreateCookieForModal", function () {
        });
        var tour = new Tour({
            steps: [{

                element: "#step1",
                title: "Add Expiration Item",
                content: "Add new expiration items here. View list of all the detailed expiration items, change and update and delete expiration items.",
                placement: "top",
                backdrop: true,
            },
                {
                ...
                },
                {
                    ...
                    content: "See at a glance the status of all the expiration items registered in the system.",
                    placement: "bottom",
                    backdrop: true,
                },
                {
                    ...
                    content: "Update your user account settings, password settings and notification settings here.",
                    placement: "bottom"
                ...
                },
                 {
                     element: "#step5",
                     title: "Activity",
                     content: "View all the activity performed in the system here.",
                     placement: "bottom"                  
